...
public class RecyclerViewOverScrollDecorAdapter implements IOverScrollDecoratorAdapter {
    ...
    public RecyclerViewOverScrollDecorAdapter(RecyclerView mRecyclerView) {
    ...
    public RecyclerViewOverScrollDecorAdapter(RecyclerView mRecyclerView, Impl mImpl) {
        this.mRecyclerView = mRecyclerView;
        this.mImpl = mImpl;
    }

    public RecyclerViewOverScrollDecorAdapter(RecyclerView mRecyclerView, ItemTouchHelper.Callback itemTouchHelperCallback) {
        this(mRecyclerView);
    }
